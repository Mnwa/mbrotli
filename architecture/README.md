...
| --- | --- |
| [ci.md](ci.md) | Automatic tests, lints and checks; compiler-specific AFL runtime setup; manually dispatched coverage, Miri, sanitizer, fuzz campaigns and benchmarks. |
| [parallel-compression.md](parallel-compression.md) | Caller-scheduled independent segments, q0–q11 aligned fragments, completion lifecycle, bounded staging with standard-library file spools, generic seekable/positional sources, writer output and release gates. |
...
graph TD
    ...
    parallelcore --> spoolcore["parallel::core::spool<br/>(exclusive std::fs files and drop cleanup)"]
