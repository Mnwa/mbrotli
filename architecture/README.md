...
| Specification | Scope |
| --- | --- |
| [Implementation comparison](benchmark-comparison.md) | Isolated five-encoder Criterion suite, validation, size/timing export, and quality-by-quality dataset reports. |
