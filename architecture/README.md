...
graph TD
    ...
    subgraph private["Private implementation"]
        ...
        rfc["core::rfc9841<br/>(ResolvedWindow: header, declared vs<br/>retained window; SharedContextInner,<br/>PrefixSources, PreparedPrefix)"]
...
| `src/compressor/core/rfc9841/` | Private RFC 9841 primitives: window resolution and stream-header encoding; the shared context's dictionary sources, their virtual-concatenation addressing and match scan, and the prepared hash index ported from the reference's compound dictionary. |
