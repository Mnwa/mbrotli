...
| mbrotli | 1.053× | 1.000× | 8 |
| Rust brotli | 0.283× | 1.000× | 8 |
| SIMD Brotli | 0.266× | 1.000× | 8 |
| Burli | 0.832× | 1.006× | 8 |
...
[repeated-1m](#repeated-1m) · [text-1m](#text-1m) · [empty](#empty) · [alice29](#alice29) · [random-1m](#random-1m) · [binary-64k](#binary-64k) · [random-64k](#random-64k) · [tiny-text](#tiny-text)

### repeated-1m

1 MiB of repeated a bytes. **Input: 1,048,576 bytes.**

mbrotli speed / fastest peer (Burli): **1.947×**; output: 13 / 13 bytes.
...
mbrotli speed / fastest peer (Google C): **1.197×**; output: 56,879 / 56,879 bytes.
...
mbrotli speed / fastest peer (Google C): **1.167×**; output: 1 / 1 bytes.
...
mbrotli speed / fastest peer (Burli): **0.933×**; output: 56,863 / 58,707 bytes.
...
mbrotli speed / fastest peer (Google C): **0.881×**; output: 1,048,581 / 1,048,581 bytes.
...
mbrotli speed / fastest peer (Burli): **0.822×**; output: 2,687 / 2,760 bytes.
...
mbrotli speed / fastest peer (Google C): **0.817×**; output: 65,540 / 65,540 bytes.
...
mbrotli speed / fastest peer (Google C): **0.748×**; output: 46 / 46 bytes.
